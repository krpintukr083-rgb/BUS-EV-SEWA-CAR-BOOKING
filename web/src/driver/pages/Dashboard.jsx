    ...
    <div>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          <Link to="/driver/driver-status" className="btn btn-primary">
            Change Duty Status
          </Link>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px' }}>
        ...
        <div className="content-card">
          <div className="card-header-flex">
            ...
            <Link to="/driver/booking-requests" className="btn btn-outline" style={{ fontSize: '0.8rem', padding: '4px 10px' }}>
        ...
        <div className="content-card">
          <div className="card-header-flex">
            ...
            <Link to="/driver/assigned-vehicle" className="btn btn-outline" style={{ fontSize: '0.8rem', padding: '4px 10px' }}>
      ...
      <div className="content-card">
        <div className="card-header-flex">
          ...
          <Link to="/driver/booking-history" className="btn btn-outline" style={{ fontSize: '0.8rem', padding: '4px 10px' }}>
